...
knitr::opts_knit$set(root.dir = "E:/Course & Studies/Software/work area/Repos/Bangalore Traffic")
```
...
```{r Data handling, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Month wise , echo=FALSE, message=FALSE, warning=FALSE}
...
```{r ARIMA Model, echo=FALSE, message=FALSE, warning=FALSE}
