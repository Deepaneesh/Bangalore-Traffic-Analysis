...
library(forecast)
library(DT)
colnames(Banglore_traffic_Dataset)
...
graph2=k %>% ggplot(aes(x=Speed,y=Congestion))+geom_smooth(se=F)+geom_point()
k
graph2
...
library(htmlwidgets)
saveWidget(plotgraph,"plot.html")
browseURL("plot.html")
saveWidget(plotlygraph2,"plot2.html")
browseURL("plot2.html")
